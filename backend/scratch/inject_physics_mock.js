...
const mockPath = path.resolve(__dirname, 'fisica-cap1-mockup.json');
...
// 2. Cargar el mockup de física generado
...
try {
  ...
  console.log('🎉 ¡Inyección exitosa! Los placeholders del capítulo 1 de física han sido reemplazados por las 80 preguntas reales en capitulos-mock-local.json');
} catch (e) {
