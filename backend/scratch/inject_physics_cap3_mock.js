...
// Rutas de archivos usando rutas absolutas en el proyecto para evitar cualquier confusión de CWD
const officialPath = 'c:\\Users\\Shila\\Documents\\Proy\\estudiauni.cl\\frontend-app\\src\\assets\\mocks\\capitulos-mock-local.json';
const mockPath = path.resolve(__dirname, 'fisica-cap3-mockup.json');
...
// 2. Cargar el mockup de física generado (Capítulo 3)
...
try {
  ...
  console.log('🎉 ¡Inyección exitosa! Los placeholders del capítulo 3 de física (Energía - Tierra) han sido reemplazados por las 60 preguntas reales en capitulos-mock-local.json');
} catch (e) {
