...
const mockPath = path.resolve(__dirname, 'fisica-cap4-mockup.json');
...
// 2. Cargar el mockup de física generado (Capítulo 4)
...
try {
  ...
  console.log('🎉 ¡Inyección exitosa! Los placeholders del capítulo 4 de física (Electricidad) han sido reemplazados por las 50 preguntas reales en capitulos-mock-local.json');
} catch (e) {
