...
const MATERIAS = [
  ...
  { id: 'historia',     title: 'Historia y Cs. Soc.', slug: 'historia',            icon: '🏛️', order: 3, isActive: false },
...
// ── SECCIONES CAP 1: LOCALIZAR (5 nodos) ────────────────────
const SECCIONES_CAP1 = [
  ...
  { id: 'loc-2', capituloId: 'cap-localizar', materiaId: 'comp-lectora', order: 2, testId: 'test-loc-2',
    title: 'Rastrear información explícita (Texto narrativo)',
  ...
  { id: 'loc-3', capituloId: 'cap-localizar', materiaId: 'comp-lectora', order: 3, testId: 'test-loc-3',
    title: 'Identificar sinónimos y paráfrasis (Texto informativo)',
  ...
  { id: 'loc-4', capituloId: 'cap-localizar', materiaId: 'comp-lectora', order: 4, testId: 'test-loc-4',
    title: 'Identificar sinónimos y paráfrasis (Texto narrativo)',
  ...
  { id: 'loc-boss', capituloId: 'cap-localizar', materiaId: 'comp-lectora', order: 5, testId: 'test-loc-boss', isBoss: true,
    title: '⚔️ Desafío: Localizar información',
    introduccion: '¡Es hora de demostrar todo lo que aprendiste sobre localizar! Este desafío mezcla textos informativos y narrativos con mayor dificultad. Necesitas 70% para avanzar.',
    datos_claves: ['Aplica todo lo que sabes: **busca palabras clave**, reconoce **paráfrasis** y descarta distractores.','Lee el texto **dos veces** antes de responder.','**Gestiona bien el tiempo** — cada pregunta vale.'] },
];
...
const SECCIONES_CAP2 = [
  ...
  { id: 'int-boss', capituloId: 'cap-interpretar', materiaId: 'comp-lectora', order: 12, testId: 'test-int-boss', isBoss: true,
    ...
    introduccion: '¡El gran desafío de interpretación! Pondrás a prueba todas tus habilidades: inferencias, relaciones, estructura, tesis y análisis literario. Necesitas 70% para avanzar.',
...
const SECCIONES_CAP3 = [
  ...
  { id: 'ev-boss', capituloId: 'cap-evaluar', materiaId: 'comp-lectora', order: 11, testId: 'test-ev-boss', isBoss: true,
    ...
    introduccion: '¡El gran desafío final de la campaña! Demostrarás que puedes detectar intenciones, evaluar recursos, analizar el tono y relacionar textos con su contexto. ¡Necesitas 70% para completar la ruta!',
