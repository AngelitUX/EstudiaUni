      ...
      preguntas: [
        {
          ...
          alternativas: {
            A: 'Juan iba a tomar un avión.',
            B: 'Juan estaba llegando tarde a su tren o metro.',
            C: 'Juan perdió el transporte.',
            D: 'Juan estaba escapando de alguien.'
          },
          respuesta_correcta: 'B',
      ...
      preguntas: [
        {
          ...
          tipo_alternativas: 'texto',
          alternativas: {
            A: 'Los plásticos biodegradables son muy caros de producir.',
            B: 'La crisis de los océanos se debe a la falta de campañas ecologistas.',
            C: 'Los intereses económicos de las industrias obstaculizan la solución al problema del plástico.',
            D: 'La ciencia no ha logrado encontrar una alternativa al plástico.'
          },
          respuesta_correcta: 'C',
      ...
      preguntas: [
        {
          ...
          respuesta_correcta: 'B',
          feedback_acierto: '¡Correcto! El estudio es solo un ejemplo (idea secundaria/accesoria) usado para apoyar la afirmación fundamental sobre cómo la luz azul inhibe la melatonina.',
          feedback_error: 'Fíjate que la oración empieza con \'Por ejemplo\'. ¿Qué jerarquía tiene un ejemplo respecto a la idea central?'
        },
        {
          id: 261,
          enunciado: '¿Cuál de las siguientes corresponde a la información más importante (fundamental) del fragmento?',
          alternativas: {
            A: 'Leer en un e-reader retrasa el inicio del sueño en unos 20 minutos.',
            B: 'Los especialistas recomiendan un \'toque de queda digital\'.',
            C: 'La luz azul de las pantallas altera la secreción de melatonina y, por tanto, afecta la calidad del sueño.',
            D: 'Los teléfonos móviles son los dispositivos que emiten más luz azul.'
          },
          respuesta_correcta: 'C',
          feedback_acierto: '¡Excelente! La opción C resume la tesis principal y su causa directa. Las demás opciones son conclusiones derivadas, ejemplos o afirmaciones que ni siquiera están en el texto.',
          feedback_error: 'La información fundamental es aquella sin la cual el texto perdería su sentido principal. ¿De qué trata realmente todo el párrafo?'
        }
      ]
    }
  },
      ...
      preguntas: [
        {
          ...
          respuesta_correcta: 'B',
          feedback_acierto: '¡Correcto! El polvo iluminado por el sol es una descripción ambiental. Si la omites, la historia principal (Lucía entrando a buscar el testamento) sigue avanzando igual.',
          feedback_error: 'Un evento accesorio es aquel que puede eliminarse sin que la trama pierda su sentido principal. ¿Cuál de esas opciones es puramente descriptiva?'
        },
        {
          id: 263,
          enunciado: '¿Qué información es la MÁS importante (núcleo) para entender las acciones del personaje?',
          alternativas: {
            A: 'La antigüedad de los retratos y el ruido de la puerta.',
            B: 'La búsqueda del testamento para probar una traición.',
            C: 'El sonido que hacen las tablas del suelo al caminar.',
            D: 'El horario en el que se desarrolla la acción (la tarde).'
          },
          respuesta_correcta: 'B',
          feedback_acierto: '¡Excelente! El motivo que impulsa toda la escena y la trama es probar la traición de su hermano. Esa es la información jerárquicamente fundamental.',
          feedback_error: '¿Por qué Lucía está en esa habitación? ¿Qué busca? Esa motivación es el núcleo de la escena.'
        }
      ]
    }
  },
      ...
      preguntas: [
        {
          ...
          alternativas: {
            ...
            B: 'Para demostrar que las universidades investigan sobre el cerebro.',
            C: 'Para respaldar con una fuente de autoridad la idea de que el sueño es vital para aprender.',
            D: 'Para criticar los métodos de enseñanza actuales.'
          },
          respuesta_correcta: 'C',
  ...
  },
  {
    ...
    test: {
      ...
      preguntas: [
        {
          id: 268,
          enunciado: '¿Cuál es la información de mayor jerarquía (idea principal) del texto?',
          alternativas: {
      ...
      preguntas: [
        {
          ...
          tipo_alternativas: 'texto',
          alternativas: {
            A: 'De objetivo a crítico',
            B: 'De crítico a esperanzador',
            C: 'De irónico a pesimista',
            D: 'De entusiasta a apático'
          },
      ...
      preguntas: [
        {
          ...
          alternativas: {
            A: 'El exceso de información en internet es la causa principal del analfabetismo.',
            B: 'Vivimos en una paradoja donde la abundancia de información coexiste con una creciente desinformación y desconfianza en la ciencia.',
            C: 'Las plataformas digitales deberían ser reguladas por el Estado para evitar la desinformación.',
            D: 'Galileo, Darwin y Einstein son los únicos científicos que merecen ser recordados.'
          },
          respuesta_correcta: 'B',
          feedback_acierto: '¡Correcto! La tesis se formula en las primeras dos oraciones: la paradoja de información abundante + desinformación creciente. El resto del texto son los argumentos que explican esa paradoja.',
          feedback_error: 'La tesis debe cubrir el argumento central del texto completo. El texto no propone regular internet ni exalta solo a esos científicos.'
        },
        {
          id: 242,
          enunciado: '¿Cuál es el significado de \'burbujas cognitivas\' en el contexto del texto?',
          alternativas: {
            A: 'Espacios físicos donde se discute ciencia de forma aislada.',
            B: 'Entornos informativos donde la persona solo recibe información que confirma sus propias creencias.',
            C: 'Errores de pensamiento producidos por el exceso de información.',
            D: 'Plataformas digitales diseñadas para aislar a los usuarios.'
          },
          respuesta_correcta: 'B',
          feedback_acierto: '¡Brillante! El texto lo explica en la oración anterior: \'Cada plataforma... reforzando nuestras convicciones en lugar de cuestionarlas.\'',
          feedback_error: 'El texto explica qué produce las burbujas justo antes de mencionar el término. Vuelve a la oración anterior. Ahí está su definición contextual.'
        },
        {
          id: 243,
          enunciado: '¿Qué función cumple la mención de Galileo, Darwin y Einstein en el texto?',
          alternativas: {
            A: 'Ejemplificar que la resistencia a las nuevas ideas es histórica, pero se superó con evidencia, en contraste con el discurso emocional actual.',
            B: 'Demostrar que la ciencia siempre ha sido perseguida por el Estado.',
            C: 'Argumentar que solo los genios pueden descubrir la verdad.',
            D: 'Mostrar que el desacuerdo intelectual nunca tiene solución.'
          },
          respuesta_correcta: 'A',
          feedback_acierto: '¡Excelente! El autor usa a estos científicos para establecer un contraste: ellos también enfrentaron resistencia, pero la superaron con evidencia. Hoy, en cambio, solo se tiene \'la intensidad del sentimiento\'.',
          feedback_error: 'Fíjate en la frase que sigue: \'La diferencia es que ellos ofrecieron evidencia. Hoy... solo el sentimiento.\' Ese contraste es la función del ejemplo.'
        },
        {
          id: 244,
          enunciado: '¿Cuál es la actitud del emisor frente al fenómeno que describe?',
          alternativas: {
            A: 'Optimista: cree que la situación mejorará con el tiempo y la educación.',
            B: 'Crítica y preocupada: señala una contradicción peligrosa de la sociedad actual sin ofrecer una solución explícita.',
            C: 'Neutral: solo presenta datos sin tomar posición.',
            D: 'Irónica pero indiferente: describe el problema como algo inevitable.'
          },
          respuesta_correcta: 'B',
          feedback_acierto: '¡Perfecto! El emisor usa \'paradójicamente\', \'incomoda\', \'impensables\' y afirma que el único argumento hoy es \'la intensidad del sentimiento\'. Todo revela preocupación y postura crítica.',
          feedback_error: '¿Propone soluciones el texto? No. ¿Es neutral? No: toma posición clara. ¿Qué tipo de actitud corresponde a alguien que diagnostica un problema con preocupación?'
        },
        {
          id: 245,
          enunciado: '¿Qué se puede INFERIR de la expresión \'no fue el acceso a más información lo que nos hizo más críticos\'?',
          alternativas: {
            A: 'Tener más información siempre conduce a mejores decisiones.',
            B: 'Acceder a más información no garantiza un pensamiento más riguroso o crítico.',
            C: 'El autor cree que deberíamos tener acceso a menos información.',
            D: 'La información científica es inferior a la de las redes sociales.'
          },
          respuesta_correcta: 'B',
          feedback_acierto: '¡Correcto! La afirmación niega la idea de que \'más información = más pensamiento crítico\'. La inferencia válida es que la cantidad de información no garantiza la calidad del razonamiento.',
          feedback_error: 'El texto no dice que debería haber menos información. Niega una ecuación: cantidad de info ≠ calidad del pensamiento.'
        },
        {
          id: 246,
          enunciado: '¿Cuál es el argumento central que explica la paradoja del texto?',
          alternativas: {
            A: 'Las personas no leen suficiente para aprovechar la información disponible.',
            B: 'Las plataformas digitales están diseñadas para mostrar contenido que refuerza las creencias del usuario, dificultando el pensamiento crítico.',
            C: 'Los medios de comunicación tradicionales son más confiables que las redes sociales.',
            D: 'La ciencia es demasiado compleja para ser comprendida por el público general.'
          },
          respuesta_correcta: 'B',
          feedback_acierto: '¡Excelente! El texto explica la paradoja: las plataformas \'aprenden a mostrarnos lo que queremos ver, reforzando nuestras convicciones\'. Ese mecanismo algorítmico es el argumento central.',
          feedback_error: 'La explicación de la paradoja está en la mitad del texto. ¿Cuál es el mecanismo que el autor identifica como responsable?'
        },
        {
          id: 247,
          enunciado: '¿Qué relación lógica establece la palabra \'paradójicamente\' en la primera oración?',
          alternativas: {
            A: 'Introduce una causa que explica el fenómeno de la desinformación.',
            B: 'Indica que lo que sigue contradice lo que normalmente esperaríamos de la situación descrita.',
            C: 'Resume lo que se explicará en los párrafos siguientes.',
            D: 'Establece una comparación entre el pasado y el presente.'
          },
          respuesta_correcta: 'B',
          feedback_acierto: '¡Correcto! \'Paradójicamente\' siempre introduce algo inesperado o contradictorio. Esperaríamos que más información llevara a menos desinformación, pero ocurre lo contrario.',
          feedback_error: '\'Paradójicamente\' señala algo inesperado o contradictorio. ¿Qué contradicción introduce aquí?'
        },
        {
          id: 248,
          enunciado: 'De acuerdo con el texto, ¿qué diferencia a los científicos mencionados de quienes hoy difunden desinformación?',
          alternativas: {
            A: 'Los científicos eran más inteligentes y mejor educados.',
            B: 'Los científicos tenían apoyo institucional que les permitía superar la resistencia.',
            C: 'Los científicos sustentaban su disidencia en evidencia, mientras que hoy se usa la intensidad emocional como argumento.',
            D: 'Los científicos no usaban medios digitales para difundir sus ideas.'
          },
          respuesta_correcta: 'C',
          feedback_acierto: '¡Brillante! El texto lo dice explícitamente: \'La diferencia es que ellos ofrecieron evidencia. Hoy... el único argumento es la intensidad del sentimiento.\'',
          feedback_error: 'Busca la frase \'La diferencia es que...\' y lee lo que viene después.'
        },
        {
          id: 249,
          enunciado: '¿Con cuál de las siguientes afirmaciones estaría de acuerdo el autor del texto?',
          alternativas: {
            A: 'El pensamiento crítico se desarrolla naturalmente cuando se tiene acceso a internet.',
            B: 'La intensidad con que se cree algo es una forma válida de argumentar.',
            C: 'El desacuerdo intelectual es valioso cuando se basa en evidencia, pero peligroso cuando solo se basa en emociones.',
            D: 'Las plataformas digitales han mejorado la calidad del debate público.'
          },
          respuesta_correcta: 'C',
          feedback_acierto: '¡Perfecto! El texto valora el desacuerdo de los científicos (sustentado en evidencia) y critica el desacuerdo emocional actual. La opción C sintetiza exactamente esa distinción.',
          feedback_error: 'El autor critica el debate emocional y valora la evidencia. ¿Cuál opción refleja esa posición sin exagerar ni contradecir lo que el texto dice?'
        },
        {
          id: 250,
          enunciado: '¿Cuál sería el mejor título para este texto?',
          alternativas: {
            A: 'Los peligros de internet en el mundo moderno.',
            B: 'Galileo, Darwin y Einstein: lecciones para el siglo XXI.',
            C: 'La paradoja informativa: cuando más datos no significa más verdad.',
            D: 'Cómo las plataformas digitales controlan nuestra mente.'
          },
          respuesta_correcta: 'C',
          feedback_acierto: '¡Excelente! Un título debe capturar la idea principal completa. La opción C recoge la paradoja central (más información ≠ más verdad) sin exagerar ni reducir el argumento.',
          feedback_error: 'El título debe reflejar el argumento COMPLETO del texto. Descarta los que se centran en un solo detalle. ¿Cuál captura la paradoja central?'
        }
      ]
    }
  }
