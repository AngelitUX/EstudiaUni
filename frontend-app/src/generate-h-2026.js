...
const IMAGES_DIR = path.resolve(__dirname, 'assets/images/H-2026-IMAGENES');
const OUTPUT_FILE = path.resolve(__dirname, 'assets/h-2026-preguntas-db.json');
...
for (let i = 1; i <= 65; i++) {
  ...
  questions.push({
    ...
    text: `Pregunta ${i}`,
    imageUrl: imageExists ? `assets/images/H-2026-IMAGENES/${i}.png` : null,
    options: {
      A: '',
      B: '',
      C: '',
