...
const IMAGES_DIR = path.resolve(__dirname, 'assets/images/M2-2025-IMAGENES');
const OUTPUT_FILE = path.resolve(__dirname, 'assets/m2-2025-preguntas-db.json');
...
for (let i = 1; i <= 55; i++) {
  ...
  questions.push({
    ...
    subject: 'Matemática',
    text: `Pregunta ${i}`,
    imageUrl: imageExists ? `assets/images/M2-2025-IMAGENES/${i}.png` : null,
    options: {
      A: '',
      B: '',
      C: '',
