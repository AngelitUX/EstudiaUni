...
const IMAGES_DIR = path.resolve(__dirname, 'assets/images/F-2024-IMAGENES');
const OUTPUT_FILE = path.resolve(__dirname, 'assets/f-2024-preguntas-db.json');
...
for (let i = 1; i <= 80; i++) {
  ...
  questions.push({
    ...
    subject: 'Física',
    text: `Pregunta ${i}`,
    imageUrl: imageExists ? `assets/images/F-2024-IMAGENES/${i}.png` : null,
    options: {
      A: '',
      B: '',
      C: '',
