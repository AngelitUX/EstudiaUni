      ...
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          <a class="nav-item" routerLink="/dashboard">
            <img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_Inicio.avif" alt="Inicio" class="nav-icon-img"/>
            <span class="nav-text">Inicio</span>
          </a>
          <a class="nav-item" routerLink="/ruta">
            <img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_RutaDeAprendizaje.avif" alt="Ruta de Aprendizaje" class="nav-icon-img"/>
            <span class="nav-text">Ruta de Aprendizaje</span>
          </a>

          <a class="nav-item active" routerLink="/ensayos">
            <img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_EnsayosPaes.avif" alt="Ensayos PAES" class="nav-icon-img"/>
            <span class="nav-text">Ensayos PAES</span>
          </a>
          <a class="nav-item" routerLink="/mini-ensayo">
            <img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_MiniEnsayos.avif" alt="Mini Ensayos" class="nav-icon-img"/>
            <span class="nav-text">Mini Ensayos</span>
          </a>
          <a class="nav-item" routerLink="/mente-veloz">
            <img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_MenteVeloz.avif" alt="Mente Veloz" class="nav-icon-img"/>
          ...
          <div class="sidebar-sub-items" [class.expanded]="herramientasExpanded" [class.collapsible]="isCollapsible">
            <a class="nav-item" routerLink="/encuentra-tu-carrera">
              <img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_EnncuentraTuCarrera.avif" alt="Encuentra tu Carrera" class="nav-icon-img"/>
              <span class="nav-text">Encuentra tu Carrera</span>
            </a>
            <a class="nav-item" routerLink="/calculadora-nem">
              <img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_CalculadoraNEM.avif" alt="Calculadora NEM" class="nav-icon-img"/>
              <span class="nav-text">Calculadora NEM</span>
            </a>
            <a class="nav-item" routerLink="/recursos">
              <img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_RecursosAdicionales.avif" alt="Recursos Adicionales" class="nav-icon-img"/>
      ...
      <div class="mobile-overlay" [class.open]="mobileOpen" (click)="mobileOpen = false">
        <div class="mobile-menu" (click)="$event.stopPropagation()">
          ...
          <nav class="sidebar-nav">
            ...
            <a class="nav-item active" routerLink="/ensayos" (click)="mobileOpen=false"><img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_EnsayosPaes.avif" alt="Ensayos PAES" class="nav-icon-img"/><span class="nav-text">Ensayos PAES</span></a>
          ...
          <div style="padding: 1rem; border-top: 1px solid rgba(255,255,255,0.1); display: flex; flex-direction: column; gap: 0.5rem;">
            <a class="nav-item" (click)="showSettingsModal = true; mobileOpen=false"><img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_Configuracion.avif" alt="Configuración" class="nav-icon-img nav-icon-img-config"/><span class="nav-text">Configuración</span></a>
            <a class="nav-item logout-btn-sidebar" (click)="confirmLogout(); mobileOpen=false"><img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_CerrarSesion.avif" alt="Cerrar Sesión" class="nav-icon-img"/><span class="nav-text">Cerrar Sesión</span></a>
          </div>
        </div>
      </div>
  ...
  styles: [`
    ...
    @media (max-width: 1024px) {
      ...
      .dashboard-header {
        ...
        /* padding-top en 72px (no 1rem): .main-content trae "padding: 0 !important" en
           este archivo, así que sin esto el título quedaba tapado detrás de la barra
           fija de 60px (el mismo valor que ya usa .dashboard-body más abajo). */
      ...
      /* Plan Básico: el header fijo mide 104px (60px + fila de la píldora PRO) en vez de 60px;
         como aquí el aire para no quedar tapado se reserva en .dashboard-header (no en
         .main-content, que trae "padding: 0 !important"), el bump va sobre ese mismo elemento. */
      .mobile-header.mobile-header-with-pro ~ .main-content .dashboard-header { padding-top: 116px !important; }
      .dashboard-body { padding: 1rem 1rem 2rem !important; }
    ...
    @media (max-width: 768px) {
      ...
      /* Plan Básico: el header fijo mide 104px (60px + fila de la píldora PRO) en vez de 60px;
         ...
         .main-content, que trae "padding: 0 !important"), el bump va sobre ese mismo elemento. */
      .mobile-header.mobile-header-with-pro ~ .main-content .dashboard-header { padding-top: 116px !important; }
      .dashboard-body { padding: 1rem 0.85rem 2rem !important; }
  ...
  pruebas: Prueba[] = [
    {
      id: 'm1',
      nombre: 'M1',
      icono: 'assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_m1.avif',
    ...
    },
    {
      id: 'm2',
      nombre: 'M2',
      icono: 'assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_m2.avif',
    ...
    },
    {
      ...
      icono: 'assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_Lenguaje.avif',
    ...
    },
    {
      id: 'ciencias',
      nombre: 'Ciencias',
      icono: 'assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_Biologia.avif',
    ...
    },
    {
      ...
      icono: 'assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_Historia.avif',
