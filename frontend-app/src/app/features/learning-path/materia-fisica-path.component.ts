...
@Component({
  ...
  template: `
      ...
      <main class="main-content animate-fade-in-down" *ngIf="materia() as m">
        ...
        <div class="dashboard-body" style="position: relative; overflow: hidden; min-height: 100vh;">
          ...
          <div class="physics-bg-decorations">
            ...
            <span class="bg-deco" style="top: 88%; right: 5%; font-size: 2.6rem; transform: rotate(-14deg);">π</span>
            <span class="bg-deco" style="top: 6%; right: 22%; font-size: 1.9rem; transform: rotate(-6deg);">Δ</span>
            <span class="bg-deco" style="top: 94%; left: 20%; font-size: 1.9rem; transform: rotate(9deg);">θ</span>
            <span class="bg-deco" style="top: 22%; left: 16%; font-size: 1.8rem; transform: rotate(14deg);">λ</span>
            <span class="bg-deco" style="top: 8%; left: 30%; font-size: 1.8rem; transform: rotate(-9deg);">⚡</span>
    ...
    <app-infinite-mastery-modal *ngIf="showInfiniteMastery" [materiaId]="'fisica'" (close)="showInfiniteMastery = false"></app-infinite-mastery-modal>
