...
@Component({
  ...
  styles: [`
    ...
    .bg-deco { position: absolute; color: var(--accent-primary, #1e3a8a); opacity: 0.25; font-family: var(--font-heading, 'Nunito', sans-serif); font-weight: 800; user-select: none; }
