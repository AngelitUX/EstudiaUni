      ...
      <main class="main-content animate-fade-in-down" *ngIf="materia() as m">
        ...
        <div class="dashboard-body" style="position: relative; overflow: hidden; min-height: 100vh;">
          ...
          <div class="physics-bg-decorations">
            ...
            <span class="bg-deco" style="top: 94%; left: 20%; font-size: 1.9rem; transform: rotate(9deg);">Fe²⁺</span>
            <span class="bg-deco" style="top: 22%; left: 16%; font-size: 1.8rem; transform: rotate(14deg);">Oxidación</span>
            <span class="bg-deco" style="top: 92%; right: 25%; font-size: 1.8rem; transform: rotate(7deg);">Cl⁻</span>
          </div>
