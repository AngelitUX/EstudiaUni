                ...
                <div class="chapter-splash" [ngClass]="[item.capituloId, getChapterProgress(item.capituloId).pct === 100 ? 'chapter-completed' : '']" style="margin-bottom: 7rem; width: 100%;">
                  ...
                  <div class="splash-hero">
                    <div class="splash-mascot-area">
                      <img src="assets/images/Nuevos VideosEIlustraciones/GifsFocoWEBP/focoQuimica.webp" alt="Capítulo" class="splash-mascot chapter-image-custom" width="290" height="290" loading="lazy" decoding="async" />
                    </div>
