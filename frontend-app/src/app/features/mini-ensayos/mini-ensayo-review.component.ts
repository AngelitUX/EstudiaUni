...
@Component({
    ...
    <div class="ensayos-container">
      ...
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          <a class="nav-item active" routerLink="/mini-ensayo"><img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_MiniEnsayos.avif" alt="Mini Ensayos" class="nav-icon-img"/><span class="nav-text">Mini Ensayos</span></a>
      ...
      <div class="mobile-overlay" [class.open]="mobileOpen" (click)="mobileOpen = false">
        <div class="mobile-menu" (click)="$event.stopPropagation()">
          ...
          <nav class="sidebar-nav">
            ...
            <a class="nav-item active" routerLink="/mini-ensayo" (click)="mobileOpen=false"><img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_MiniEnsayos.avif" alt="Mini Ensayos" class="nav-icon-img"/><span class="nav-text">Mini Ensayos</span></a>
  ...
  styles: [`
    ...
    @media (max-width: 1024px) {
      ...
      .dashboard-body { padding: 1.5rem !important; }
