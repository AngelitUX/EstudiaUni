...
@Component({
      ...
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          <div class="sidebar-sub-items" [class.expanded]="herramientasExpanded" [class.collapsible]="isCollapsible">
            ...
            <a class="nav-item active" routerLink="/calculadora-nem"><img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_CalculadoraNEM.avif" alt="Calculadora NEM" class="nav-icon-img"/><span class="nav-text">Calculadora NEM</span></a>
        ...
        <div class="mobile-menu" (click)="$event.stopPropagation()">
          ...
          <nav class="sidebar-nav">
            ...
            <div class="sidebar-sub-items" [class.expanded]="herramientasExpanded" [class.collapsible]="isCollapsible">
              ...
              <a class="nav-item active" routerLink="/calculadora-nem" (click)="mobileOpen=false"><img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_CalculadoraNEM.avif" alt="Calculadora NEM" class="nav-icon-img"/><span class="nav-text">Calculadora NEM</span></a>
            ...
            <div class="inputs-section glass-card">
              ...
              <div class="target-section">
                ...
                <div class="target-inputs">
                  <div class="input-group">
                    <label for="targetPuntaje">Puntaje NEM Meta</label>
                    <input id="targetPuntaje" type="number" [(ngModel)]="targetPuntaje" min="100" max="1000" placeholder="Ej: 800" (blur)="validateTargetPuntaje()" (change)="validateTargetPuntaje()">
                  </div>
            ...
            <div class="results-section glass-card" [class.has-result]="promedioCalculado > 0">
              <div class="results-content">
                <div class="result-box promedio-box">
                  <img src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_m2.avif" alt="Promedio General" class="r-icon"/>
                  <div class="r-data">
  ...
  styles: [`
    ...
    .r-icon { width: 48px; height: 48px; object-fit: contain; flex-shrink: 0; }
