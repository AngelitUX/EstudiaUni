...
@Component({
    ...
    <div class="career-layout">
      ...
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          <div class="sidebar-sub-items" [class.expanded]="herramientasExpanded" [class.collapsible]="isCollapsible">
            <a class="nav-item active" routerLink="/encuentra-tu-carrera"><img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_EnncuentraTuCarrera.avif" alt="Encuentra tu Carrera" class="nav-icon-img"/><span class="nav-text">Encuentra tu Carrera</span></a>
      ...
      <div class="mobile-overlay" [class.open]="mobileOpen" (click)="mobileOpen = false">
        <div class="mobile-menu" (click)="$event.stopPropagation()">
          ...
          <nav class="sidebar-nav">
            ...
            <div class="sidebar-sub-items" [class.expanded]="herramientasExpanded" [class.collapsible]="isCollapsible">
              <a class="nav-item active" routerLink="/encuentra-tu-carrera" (click)="mobileOpen=false"><img decoding="async" src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_EnncuentraTuCarrera.avif" alt="Encuentra tu Carrera" class="nav-icon-img"/><span class="nav-text">Encuentra tu Carrera</span></a>
      ...
      <main class="main-content animate-fade-in-down">
        ...
        <section class="finder-form glass-card">
          <div class="form-grid">
            <div class="form-group search-group">
              <label for="carrera-query">Busca tu carrera</label>
            ...
            <div class="form-group">
              <label for="carrera-ubicacion">Ubicación</label>
              <div class="custom-select-container">
                <div class="combobox-wrapper" [class.open]="showLocDropdown()">
                  <input
                    id="carrera-ubicacion"
                    type="text"
            ...
            <div class="form-group">
              <label for="carrera-universidad">Universidad</label>
              <div class="custom-select-container">
                <div class="combobox-wrapper" [class.open]="showUniDropdown()">
                  <input
                    id="carrera-universidad"
                    type="text"
                    class="combobox-input"
          ...
          <div class="interests-section">
            <span class="interests-section-title">Selecciona tus intereses y habilidades:</span>
        ...
        <section class="results-section">
          ...
          <div *ngIf="!hasSearched()" class="welcome-search">
            <img src="assets/images/Nuevos VideosEIlustraciones/IconosAVIF/P_EnncuentraTuCarrera.avif" alt="Encuentra tu Carrera" class="welcome-icon"/>
      ...
      <aside class="ai-panel" [class.open]="isAiOpen()">
        ...
        <div class="ai-input-area">
          <label for="career-ai-chat-input" class="visually-hidden">Escribe tu pregunta al tutor IA</label>
          <textarea
            id="career-ai-chat-input"
            class="ai-input"
  ...
  styles: [`
    ...
    .interests-section-title { display: block; font-size: 0.95rem; font-weight: 700; margin-bottom: 1rem; color: var(--text-primary); }
    ...
    .welcome-icon { width: 120px; height: 120px; object-fit: contain; margin: 0 auto 1.5rem; display: block; }
    ...
    @media (max-width: 480px) {
      ...
      .welcome-icon { width: 84px; height: 84px; margin-bottom: 1rem; }
