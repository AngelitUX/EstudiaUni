...
export const baseRoutes: Routes = [
  ...
  { path: 'verify-email', component: VerifyEmailComponent, canActivate: [authGuard], data: { title: 'Verifica tu Correo', noIndex: true } },
  {
    path: 'dashboard',
    loadComponent: () => import('./features/dashboard/dashboard.component').then(m => m.DashboardComponent),
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Mi Dashboard', noIndex: true }
  },
  {
    path: 'profile',
    loadComponent: () => import('./features/profile/profile-settings.component').then(m => m.ProfileSettingsComponent),
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Mi Perfil', noIndex: true }
  },
  {
    path: 'settings',
    loadComponent: () => import('./features/profile/profile-settings.component').then(m => m.ProfileSettingsComponent),
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Configuración', noIndex: true }
  },
  {
    path: 'modules',
    loadComponent: () => import('./features/modules/modules-list/modules-list.component').then(m => m.ModulesListComponent),
    canActivate: [authGuard, emailVerifiedGuard], data: { title: 'Módulos', noIndex: true }
  },
  {
    path: 'topic/:moduleId/:topicId',
    loadComponent: () => import('./features/modules/topic-detail/topic-detail.component').then(m => m.TopicDetailComponent),
    canActivate: [authGuard, emailVerifiedGuard], data: { title: 'Tema', noIndex: true }
  },
  {
    path: 'simulation/:attemptId',
    loadComponent: () => import('./features/simulations/simulation-runner/simulation-runner.component').then(m => m.SimulationRunnerComponent),
    canActivate: [authGuard, emailVerifiedGuard], data: { title: 'Simulación', noIndex: true }
  },
  // Ensayos PAES
  {
    path: 'ensayos',
    loadComponent: () => import('./features/simulations/ensayos-list.component').then(m => m.EnsayosListComponent),
    canActivate: [authGuard, emailVerifiedGuard], data: { title: 'Ensayos PAES', noIndex: true }
  },
  {
    path: 'ensayo/:id/run',
    loadComponent: () => import('./features/simulations/ensayo-runner.component').then(m => m.EnsayoRunnerComponent),
    canActivate: [authGuard, emailVerifiedGuard], data: { title: 'Rindiendo Ensayo', noIndex: true }
  },
  {
    path: 'ensayo/:id/review',
    loadComponent: () => import('./features/simulations/ensayo-review.component').then(m => m.EnsayoReviewComponent),
    canActivate: [authGuard, emailVerifiedGuard], data: { title: 'Revisión de Ensayo', noIndex: true }
  },
  // Mini Ensayos
  {
    path: 'mini-ensayo',
    ...
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Mini Ensayo', noIndex: true }
  },
  {
    ...
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Mini Ensayo en Curso', noIndex: true }
  },
  {
    ...
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Revisión Mini Ensayo', noIndex: true }
  },
  // Ruta de Aprendizaje (Duolingo-style)
  {
    ...
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Ruta de Aprendizaje', noIndex: true }
  },
  {
    path: 'ruta/mat1',
    data: { materiaId: 'mat1', title: 'Matemática 1 · Ruta de Aprendizaje', noIndex: true },
    loadComponent: () => import('./features/learning-path/materia-math-path.component').then(m => m.MateriaMathPathComponent),
    canActivate: [authGuard, emailVerifiedGuard]
  },
  {
    path: 'ruta/mat2',
    data: { materiaId: 'mat2', title: 'Matemática 2 · Ruta de Aprendizaje', noIndex: true },
    loadComponent: () => import('./features/learning-path/materia-math-path.component').then(m => m.MateriaMathPathComponent),
    canActivate: [authGuard, emailVerifiedGuard]
  },
  {
    path: 'ruta/historia',
    data: { materiaId: 'historia', title: 'Historia · Ruta de Aprendizaje', noIndex: true },
  ...
  {
    path: 'ruta/biologia',
    data: { materiaId: 'biologia', title: 'Biología · Ruta de Aprendizaje', noIndex: true },
  ...
  },
  {
    ...
    data: { materiaId: 'ciencias-biologia', title: 'Ciencias (Biología) · Ruta de Aprendizaje', noIndex: true },
    loadComponent: () => import('./features/learning-path/materia-biologia-path.component').then(m => m.MateriaBiologiaPathComponent),
    canActivate: [authGuard, emailVerifiedGuard]
  },
  {
    ...
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Capítulo de Biología', noIndex: true }
  },
  {
    path: 'ruta/ciencias-biologia/:capituloId',
    loadComponent: () => import('./features/learning-path/capitulo-biologia-detail.component').then(m => m.CapituloBiologiaDetailComponent),
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Capítulo de Ciencias', noIndex: true }
  },
  {
    ...
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Sección de Biología', noIndex: true }
  },
  {
    path: 'ruta/ciencias-biologia/:capituloId/:seccionId',
    loadComponent: () => import('./features/learning-path/seccion-biologia-detail.component').then(m => m.SeccionBiologiaDetailComponent),
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Sección de Ciencias', noIndex: true }
  },

  // FISICA AISLADA
  {
    path: 'ruta/fisica',
    data: { materiaId: 'fisica', title: 'Física · Ruta de Aprendizaje', noIndex: true },
  ...
  },
  {
    ...
    data: { materiaId: 'ciencias-fisica', title: 'Ciencias (Física) · Ruta de Aprendizaje', noIndex: true },
    loadComponent: () => import('./features/learning-path/materia-fisica-path.component').then(m => m.MateriaFisicaPathComponent),
    canActivate: [authGuard, emailVerifiedGuard]
  },
  {
    ...
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Capítulo de Física', noIndex: true }
  },
  {
  ...
  },
  {
    ...
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Sección de Física', noIndex: true }
  },
  {
  ...
  {
    path: 'ruta/quimica',
    data: { materiaId: 'quimica', title: 'Química · Ruta de Aprendizaje', noIndex: true },
  ...
  },
  {
    ...
    data: { materiaId: 'ciencias-quimica', title: 'Ciencias (Química) · Ruta de Aprendizaje', noIndex: true },
    loadComponent: () => import('./features/learning-path/materia-quimica-path.component').then(m => m.MateriaQuimicaPathComponent),
    canActivate: [authGuard, emailVerifiedGuard]
  },
  {
    path: 'ruta/ciencias',
    data: { materiaId: 'ciencias', title: 'Ciencias · Ruta de Aprendizaje', noIndex: true },
    loadComponent: () => import('./features/learning-path/materia-quimica-path.component').then(m => m.MateriaQuimicaPathComponent),
    canActivate: [authGuard, emailVerifiedGuard]
  },
  {
  ...
  },
  {
    ...
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Capítulo', noIndex: true }
  },
  {
    ...
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Sección', noIndex: true }
  },
  {
    ...
    canActivate: [authGuard, emailVerifiedGuard],
    data: { title: 'Prueba de Matemática', noIndex: true }
  },
  {
  ...
  },
  {
    ...
    canActivate: [authGuard, adminGuard],
    data: { title: 'Admin · Modo Infinito', noIndex: true }
  },
  {
